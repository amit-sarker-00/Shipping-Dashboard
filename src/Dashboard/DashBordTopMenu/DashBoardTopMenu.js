        ...
        <div className='bg-sky-200 w-full p-1 flex items-center justify-between '>
            ...
            <div className='pr-5 pt-1 flex items-center gap-5'>
                <div className=' relative' >
                    ...
                    <p className='absolute -top-3 pt-0.5 px-2 rounded-full -right-3 text-xs bg-yellow-500'>3</p>
                </div>
                <Link className='flex items-center gap-5'>
                    <div>
                        <img className='w-10 object-cover h-10 rounded-md' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS44GEBI3itkGmqDQH2nEgzkTvwISd_ONOwkg&usqp=CAU" alt="" />
                    </div>
                    <div>
